...
// через map() - к каждому элементу добавляем необходимый символ и  все элементы преобразовываем в числа для обработки методом toFixed(2), который при необходимости добавит в конце .00
